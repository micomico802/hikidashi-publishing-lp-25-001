  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <CallToActionButton text="無料目次作成セッションに申し込む" href="https://forms.gle/asaXZkD25iFwtkaG7" className="text-base sm:text-lg lg:text-xl px-6 sm:px-10 py-3 sm:py-4 shadow-xl max-w-xs sm:max-w-none mx-auto" />
      </div>
    </section>
  );
};
