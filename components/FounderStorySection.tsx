  ...
  return (
    <section className="py-16 md:py-24 bg-neutral-light">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle text="【なぜ、私がこのサービスをあなたにお届けしたいのか？ ～hikidashi出版 代表・佐藤達矢の物語～】" />
        <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-xl shadow-xl">
          ...
          <div className="space-y-6 text-neutral-dark leading-relaxed text-lg">
            ...
            <div className="my-8 p-6 bg-secondary-light rounded-lg shadow-md text-neutral-dark">
              ...
              <img src={getImage('founderSuccess')} alt="佐藤代表の書籍成功" className="mt-4 mx-auto rounded-lg shadow-md"/>
            </div>
            <p>
