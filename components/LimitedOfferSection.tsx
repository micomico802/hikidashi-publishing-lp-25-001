  ...
  return (
    <section className="py-16 md:py-24 bg-secondary-light text-neutral-dark">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-6xl mx-auto bg-white p-8 md:p-12 rounded-xl shadow-2xl">
          <h2 className="text-3xl md:text-4xl font-bold text-primary-dark mb-6">
            最高のクオリティでお届けしたいから。
          </h2>
          <p className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4">
            hikidashi出版の各プラン、今月の新規お申し込みは
            <HighlightText className="text-3xl sm:text-4xl md:text-5xl block my-2 break-words">【残り8枠】</HighlightText>
            です！
          </p>
          <div className="max-w-6xl mx-auto">
              <img src={getImage('limitedOffer')} alt="限定オファーイメージ" className="my-8 mx-auto rounded-lg shadow-lg max-w-full h-auto"/>
          </div>
          ...
          <p className="text-xl sm:text-2xl md:text-3xl font-semibold mb-8">
            ...
            <HighlightText className="text-3xl sm:text-4xl md:text-5xl block my-2 break-words">【残り3枠】</HighlightText>
            です。
          </p>
          <CallToActionButton 
            text="今すぐ無料セッションに申し込む" 
